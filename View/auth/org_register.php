<?php
  ...
  require_once "../../Montroller/Authcontroller.php";
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if(!empty($_POST["name"]) && !empty($_POST["email"]) && !empty($_POST["password"]) && !empty($_POST["address"]) && !empty($_POST["accountNumber"])) {
      if($auth->check_email($_POST["email"])) {
        $user->set_name($_POST["name"]);
        $user->set_email($_POST["email"]);
        $user->set_password($_POST["password"]);
        $org->set_address($_POST["address"]);
        $org->set_account_num($_POST["accountNumber"]);

        $auth = new Authcontroller;
        if($auth->register_org($user ,$org)) {
          $adduser = true;
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <div class="pt-4 pb-2">
                      ...
                      <p class="text-center small">Enter your Organisation details to create account</p>
                    </div>
                    ...
                    <form class="row g-3 needs-validation" action="org_register.php" method="POST" novalidate>
                      ...
                      <div class="col-12">
                        ...
                        <input type="text" name="accountNumber" class="form-control" id="account_number" required>
                    ...
                    <div class="col-12 ">
                      <p class="small mb-0">Register as <a href="register.php">User</a>.</p>
                    </div>
