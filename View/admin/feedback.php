...
$all_feedbacks = $adminCN->getAllfeedbacks();
$num_of_feedbacks = $adminCN->getFeedbacksNum();
            ...
            <div class="card info-card sales-card">
              ...
              <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    <h6><?php echo $num_of_feedbacks[0]["count"] ?></h6>
                  </div>
                </div>
              </div>
