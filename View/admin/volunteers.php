...
$all_volunteers = $adminCN->getAllvolunteers();
      ...
      <div class="table-responsive">
        <div class="table-wrapper">
          ...
          <table class="table ">
            ...
            <!-- start volunteer table-->
            <?php
            if (count($all_volunteers) == 0) {
            ?>
              ...
              ?>
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $don["no_of_event"] ?></td>
                    <td><?php echo $don["email"] ?></td>
                    <td><?php echo $don["phone_no"] ?></td>
                  </tr>
                </tbody>
            <?php }
            } ?>
