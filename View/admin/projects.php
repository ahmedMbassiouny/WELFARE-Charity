        ...
        <div class="table-wrapper">
          ...
          <table class="table ">
            <thead>
              <tr>
                <th style="width: 6%;">#</th>
                <th style="width: 9%;">Request_id</th>
                <th style="width: 8%;">org_id</th>
                <th style="width: 10%;">Project</th>
                <th style="width: 10%;">Description</th>
                <th style="width: 8%;">Field</th>
                <th style="width: 8%;">Donors</th>
                <th style="width: 8%;">Collect</th>
                <th style="width: 8%;">Target</th>
                <th style="width: 13%;">img_url</th>
              </tr>
            </thead>

            <!-- start projects table-->
            <?php
            if ($num_of_projects[0]["count"] == 0) {
            ?>
              ...
              ?>
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $proj["req_id"] ?></td>
                    <td><?php echo $proj["org_id"] ?></td>
                    <td><?php echo $proj["project"] ?></td>
                    <td><?php echo $proj["description"] ?></td>
                    <td><?php echo $proj["field"] ?></td>
                    <td><?php echo $proj["donors"] ?></td>
                    <td><?php if ($proj["collect"] !== null) {
                          echo $proj["collect"];
                        } else {
                          echo "0";
                        } ?></td>
                    <td><?php echo $proj["target"] ?></td>
                    <td>
                      <img src="<?php echo $proj["img"] ?>" width="50px" alt="project_img">
                    </td>
                  </tr>
                </tbody>
            <?php }
