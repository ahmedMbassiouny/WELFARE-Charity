...
$all_project_req = $adminCN->getAllProjectReq();
$num_of_Project_req = $adminCN->getProjectReqNum();
$num_of_organizations = $adminCN->getOrganizationsNum();

$num_of_accepted_req = $adminCN->getacceptedProjectNum();
$num_of_waiting_req = $num_of_Project_req[0]["count"] - $num_of_accepted_req[0]["count"];


if (isset($_POST["accept"])) {
  if (!empty($_POST["req_id"])) {
    if ($adminCN->acceptProject($_POST["req_id"])) {
      $acceptMsg = "Accepted Succesfully";
      $all_project_req = $adminCN->getAllProjectReq();
      $adminCN->AddProject($_POST["req_id"]);
    }
  }
}
...
if (isset($_POST["reject"])) {
  if (!empty($_POST["req_id"])) {
    if ($adminCN->rejectProject($_POST["req_id"])) {
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Projects request</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Projects request</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $num_of_Project_req[0]["count"] ?></h6>
                    </div>
                  </div>
                </div>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $num_of_waiting_req ?></h6>
                    </div>
                  </div>
                </div>
      ...
      <div class="table-responsive">
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-6">
                <h2>Projects request <b>Details</b></h2>
              </div>
              <div class="col-sm-6">
          ...
          <table class="table ">
            <thead>
              <tr>
                ...
                <th style="width: 12%;">project_name</th>
                <th style="width: 16%;">description</th>
                <th style="width: 6%;">field</th>
            ...
            <!-- start Projects request table-->
            <?php
            if (count($all_project_req) == 0) {
            ?>
              <div class="alert alert-danger alert-dismissible fade show" role="alert">
              ...
              foreach ($all_project_req as $req) {
              ?>
                <tbody>
                  <tr>
                    <td><?php echo $req["id"] ?></td>
                    <td><?php echo $req["org_id"] ?></td>
                    <td><?php echo $req["proj_name"] ?></td>
                    <td><?php echo $req["description"] ?></td>
                    <td><?php echo $req["field"] ?></td>
                    <td><?php echo $req["target"] ?></td>
                    <td><?php echo $req["img"] ?></td>
