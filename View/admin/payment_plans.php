...
$all_payment_plans = $adminCN->getAllPaymentPlans();
$num_of_payment_plans = $adminCN->getPaymentPlansNum();
...
if (isset($_POST['planName']) && isset($_POST['duration'])) {
  if (!empty($_POST['planName']) && !empty($_POST['duration'])) {
    $payment_plan->set_name($_POST['planName']);
    $payment_plan->set_duration($_POST['duration']);

    if ($adminCN->add_payment_plan($payment_plan)) {
      $addPlan = true;
      $all_payment_plans = $adminCN->getAllPaymentPlans();
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $num_of_payment_plans[0]["count"] ?></h6>
                    </div>
                  </div>
                </div>
      ...
      <div class="table-responsive">
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-6">
                <h2>Payment Plans <b>Details</b></h2>
              </div>
              <div class="col-sm-6">
          ...
          <table class="table ">
            ...
            <!-- start Payment Plans table-->
            <?php
            if (count($all_payment_plans) == 0) {
            ?>
              <div class="alert alert-danger alert-dismissible fade show" role="alert">
                No Available papayment plans
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
              <?php
            } else {
              foreach ($all_payment_plans as $don) {
              ?>
                <tbody>
                  <tr>
                    <td><?php echo $don["id"] ?></td>
                    <td><?php echo $don["name"] ?></td>
                    <td><?php echo $don["duration"] ?></td>
                  </tr>
                </tbody>
            <?php }
            } ?>
        ...
        ?>
          <div data-delay="2000" class="bs-toast toast  fade toast-placement-ex bottom-0 start-50 show bg-info" role="alert" aria-live="assertive" aria-atomic="true" style="margin-left: 30%;">
            <div class="toast-header">
              ...
              <div class="me-auto fw-semibold">Plan added succesfully</div>
