      ...
      <div class="table-responsive">
        <div class="table-wrapper">
          ...
          <table class="table ">
            ...
            <!-- start Donations table-->
            <?php
            if ($num_of_donations[0]["count"] == 0) {
            ?>
              ...
              ?>
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $don["project"] ?></td>
                    <td><?php echo $don["amount"] ?></td>
                    <td><?php echo $don["method"] ?></td>
                    <td><?php echo $don["time"] ?></td>
