...
$all_events = $adminCN->getAllEvents();

$num_of_event_reg = $adminCN->getRegistrationNum();
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $num_of_event_reg[0]["count"] ?></h6>
                    </div>
                  </div>
                </div>
          ...
          <table class="table ">
            <thead>
              <tr>
                ...
                <th style="width: 8%;">Volunteers</th>
              ...
              ?>
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $event["req_id"] ?></td>
                    <td><?php echo $event["org_id"] ?></td>
                    <td><?php echo $event["information"] ?></td>
                    <td><?php echo $event["location"] ?></td>
                    <td><?php echo $event["name"] ?></td>
                    <td><?php echo $event["time"] ?></td>
                    <td><?php if ($event["volunteers"] !== null) {
                          echo $event["volunteers"];
                        } else {
                          echo "0";
                        } ?></td>
                    <td>
                      <img src="<?php echo $event["img"] ?>" width="50px" alt="event_img">
                    </td>
                  </tr>
                </tbody>
            <?php }
