...
$all_organizations = $adminCN->getAllorganizations();
      ...
      <div class="table-responsive">
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-6">
                <h2>organizations <b>Details</b></h2>
              </div>
              <div class="col-sm-6">
          ...
          <table class="table ">
            <thead>
              <tr>
                ...
                <th style="width: 18%;">Account_no</th>
              ...
              ?>
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $org["user_id"] ?></td>
                    <td><?php echo $org["name"] ?></td>
                    <td><?php echo $org["email"] ?></td>
                    <td><?php echo $org["account_no"] ?></td>
