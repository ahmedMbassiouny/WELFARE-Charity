...
$all_fields = $adminCN->getAllFields();
$num_of_fields = $adminCN->getFieldsNum();
...
if (isset($_POST['methodName'])) {
  if (!empty($_POST['methodName'])) {
    $field->set_name($_POST['methodName']);

    if ($adminCN->add_field($field)) {
      $addField = true;
      $all_fields = $adminCN->getAllFields();
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $num_of_fields[0]["count"] ?></h6>
                    </div>
                  </div>
                </div>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add field Form <br></h5>
              <!-- Horizontal Form -->
              <form action="" method="POST">
                ...
                <div class="row mb-3">
                  <label for="methodName" class="col-sm-2 col-form-label">Field Name</label>
                  <div class="col-sm-10">
        ...
        ?>
          <div data-delay="2000" class="bs-toast toast  fade toast-placement-ex bottom-0 start-50 show bg-info" role="alert" aria-live="assertive" aria-atomic="true" style="margin-left: 30%;">
            <div class="toast-header">
              ...
              <div class="me-auto fw-semibold">field added succesfully</div>
